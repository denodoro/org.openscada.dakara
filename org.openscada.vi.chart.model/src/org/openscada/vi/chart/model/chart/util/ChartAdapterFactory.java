 ...
 * $Id$
 */
package org.openscada.vi.chart.model.chart.util;
...
public class ChartAdapterFactory extends AdapterFactoryImpl
{
    ...
    protected ChartSwitch<Adapter> modelSwitch = new ChartSwitch<Adapter> () {
        @Override
        public Adapter caseChartView ( ChartView object )
        {
            return createChartViewAdapter ();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.openscada.vi.chart.model.chart.ChartView <em>View</em>}'.
     * <!-- begin-user-doc -->
