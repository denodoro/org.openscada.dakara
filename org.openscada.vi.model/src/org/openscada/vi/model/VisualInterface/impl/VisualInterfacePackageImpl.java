...
import static org.openscada.vi.model.VisualInterface.VisualInterfacePackage.CONTAINER;
...
public class VisualInterfacePackageImpl extends EPackageImpl implements VisualInterfacePackage
{
     ...
     * <p>
     * This method is used to initialize {@link VisualInterfacePackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to
    ...
    public void initializePackageContents ()
    {
        ...
        initEClass ( this.containerEClass, org.openscada.vi.model.VisualInterface.Container.class, "Container", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS ); //$NON-NLS-1$
        ...
        initEAttribute ( getGridChild_SpanRows (), this.ecorePackage.getEInt (), "spanRows", "0", 1, 1, GridChild.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED ); //$NON-NLS-1$ //$NON-NLS-2$
