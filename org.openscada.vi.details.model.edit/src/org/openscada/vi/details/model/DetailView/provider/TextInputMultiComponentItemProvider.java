 ...
 * @generated
 */
public class TextInputMultiComponentItemProvider
        ...
        IItemPropertySource
{
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_TextInputMultiComponent_descriptor_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_TextInputMultiComponent_descriptor_feature", "_UI_TextInputMultiComponent_type"),
                 DetailViewPackage.Literals.TEXT_INPUT_MULTI_COMPONENT__DESCRIPTOR,
                 true,
                 false,
                 false,
    ...
    public String getText(Object object)
    {
        ...
        return label == null || label.length() == 0 ?
            getString("_UI_TextInputMultiComponent_type") :
            getString("_UI_TextInputMultiComponent_type") + " " + label;
    }
