...
/**
 * This is the item provider adapter for a {@link org.openscada.vi.details.model.DetailView.PermissionVisibility} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PermissionVisibilityItemProvider extends VisibilityItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
     ...
     * @generated
     */
    public PermissionVisibilityItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors ( Object object )
    {
        if ( itemPropertyDescriptors == null )
        {
            ...
            addRequiredPermissionPropertyDescriptor ( object );
        }
    ...
    {
        itemPropertyDescriptors.add ( createItemPropertyDescriptor ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (), getResourceLocator (), getString ( "_UI_PermissionVisibility_requiredPermission_feature" ), getString ( "_UI_PropertyDescriptor_description", "_UI_PermissionVisibility_requiredPermission_feature", "_UI_PermissionVisibility_type" ), DetailViewPackage.Literals.PERMISSION_VISIBILITY__REQUIRED_PERMISSION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null ) );
    }
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/PermissionVisibility" ) );
    }
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ? getString ( "_UI_PermissionVisibility_type" ) : getString ( "_UI_PermissionVisibility_type" ) + " " + label;
    }
