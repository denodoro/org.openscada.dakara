...
import org.openscada.vi.model.VisualInterface.provider.FigureItemProvider;

/**
 * This is the item provider adapter for a {@link org.openscada.vi.chart.model.chart.ChartView} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChartViewItemProvider extends FigureItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    /**
     ...
     * @generated
     */
    public ChartViewItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/ChartView" ) );
    }
    ...
    {
        String label = ( (ChartView)object ).getName ();
        return label == null || label.length () == 0 ? getString ( "_UI_ChartView_type" ) : getString ( "_UI_ChartView_type" ) + " " + label;
    }
