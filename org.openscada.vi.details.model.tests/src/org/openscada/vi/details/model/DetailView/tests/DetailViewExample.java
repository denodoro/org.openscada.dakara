...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>DetailView</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DetailViewExample
{
    ...
    public static void main(String[] args)
    {
        ...
        if (args.length == 0)
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource(URI.createURI("http:///My.detailview"));
                View root = DetailViewFactory.eINSTANCE.createView();
