...
public class SymbolReferenceController implements Controller
{
    ...
    public SymbolReferenceController ( final SymbolController controller, final SymbolReference symbolReference, final BasicViewElementFactory factory, final ResourceManager manager )
    {
        ...
        try
        {
            ...
            final SymbolController childController = new SymbolController ( uri.toString (), controller, symbolLoader.getSymbol (), symbolLoader.getClassLoader (), properties, controller.getScriptObjects () );
